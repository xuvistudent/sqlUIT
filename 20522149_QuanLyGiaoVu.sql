...
SELECT HOCVIEN.MAHV, HO, TEN, DIEM DIEM_LANTHISAUCUNG FROM KETQUATHI JOIN HOCVIEN ON KETQUATHI.MAHV=HOCVIEN.MAHV WHERE MAMH='CSDL' AND LANTHI=(SELECT MAX(LANTHI) FROM KETQUATHI WHERE MAMH='CSDL' AND KETQUATHI.MAHV=HOCVIEN.MAHV) ORDER BY MAHV

/*CAU 18*/

SELECT HOCVIEN.MAHV, HO, TEN, DIEM DIEM_CAONHAT FROM HOCVIEN JOIN KETQUATHI ON HOCVIEN.MAHV=KETQUATHI.MAHV WHERE MAMH='CSDL' AND DIEM=(SELECT MAX(DIEM) FROM KETQUATHI WHERE MAMH='CSDL' AND KETQUATHI.MAHV=HOCVIEN.MAHV) ORDER BY MAHV
